package academy.olga.homework15.java_notebook0.src.edu.examples.java_classes.entity;

import java.util.Date;
import java.util.Objects;

import academy.olga.homework15.java_notebook0.src.edu.examples.java_classes.util.GenerateId;
